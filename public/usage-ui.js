(()=>{
  ...
  const style=document.createElement('style');style.textContent='.usage-card{max-width:520px}.usage-row{margin:18px 0}.usage-label{display:flex;justify-content:space-between;gap:16px;margin-bottom:7px}.usage-track{height:8px;background:rgba(127,127,127,.18);border-radius:999px;overflow:hidden}.usage-fill{height:100%;background:currentColor;border-radius:999px;transition:width .25s ease}.usage-remaining{margin-top:20px;padding:12px;border-radius:10px;background:rgba(127,127,127,.10);font-size:13px}';document.head.append(style);
})();
