...
const billingMounted=Symbol.for('global-ai-assistant.billing-bootstrap'),researchMounted=Symbol.for('global-ai-assistant.research-bootstrap'),verificationMounted=Symbol.for('global-ai-assistant.verification-bootstrap'),agentMounted=Symbol.for('global-ai-assistant.agent-bootstrap'),backgroundAgentMounted=Symbol.for('global-ai-assistant.background-agent-bootstrap'),governanceMounted=Symbol.for('global-ai-assistant.agent-governance-bootstrap'),taskCenterMounted=Symbol.for('global-ai-assistant.task-center-bootstrap'),auditMounted=Symbol.for('global-ai-assistant.tool-audit-bootstrap'),externalToolsMounted=Symbol.for('global-ai-assistant.external-tools-bootstrap');
express.application.use=function patchedUse(...args){if(!this[billingMounted]){registerBillingRoutes(this);this[billingMounted]=true;}const result=originalUse.apply(this,args);if(!this[researchMounted]){registerResearchRoutes(this);this[researchMounted]=true;}if(!this[verificationMounted]){registerVerificationRoutes(this);this[verificationMounted]=true;}if(!this[agentMounted]){registerAgentRoutes(this);this[agentMounted]=true;}if(!this[backgroundAgentMounted]){registerBackgroundAgentRoutes(this);this[backgroundAgentMounted]=true;}if(!this[governanceMounted]){registerAgentGovernanceRoutes(this,startBackgroundAgent);this[governanceMounted]=true;}if(!this[taskCenterMounted]){registerTaskCenterRoutes(this);this[taskCenterMounted]=true;}if(!this[auditMounted]){registerToolAuditRoutes(this);this[auditMounted]=true;}if(!this[externalToolsMounted]){registerExternalToolRoutes(this);this[externalToolsMounted]=true;}return result;};
